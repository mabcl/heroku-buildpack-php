...
cd /tmp/php-5.3.17
./configure --prefix=/app/php --with-apxs2=/app/apache/bin/apxs --with-pgsql --with-pdo-pgsql --with-iconv --with-gd --with-curl=/usr/lib --with-config-file-path=/app/php --enable-soap=shared --with-openssl --enable-mbstring --with-mhash --with-pear  --disable-cgi --with-jpeg-dir --with-png-dir --with-mcrypt=/app/local --enable-static
${MAKE_CMD} && ${MAKE_CMD} install
